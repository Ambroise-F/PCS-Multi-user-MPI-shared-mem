...
/** Compute the discrete log using a and b coefficients.
 *
 * 	@param[out]	x	The first user discrete log.
 * 	@param[in]	a1	First user a coefficient.
 * 	@param[in]	a2	Second user a coefficient.
 * 	@param[in]	b1	First user b coefficient.
 * 	@param[in]	b2	Second user b coefficient.
 *      @param[in]      x2      Second user known discrete log.
 * 	@param[in]	n	Group order.
 */
void compute_x_2users(mpz_t x, mpz_t a1, mpz_t a2, mpz_t b1, mpz_t b2, mpz_t x2, mpz_t n)
{
        mpz_t xR, xI;
